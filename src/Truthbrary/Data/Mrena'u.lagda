...
\begin{code}
  module SignV where
    ...
    s[r]≡+⇒r≥0 : (r : ℝ) → sign r ≡ Sign.+ → r ≥ fromℕ 0
    s[r]≡+⇒r≥0 = {!!}
  ...
  module Toℚ where
    ...
    toℚ∘fromℤ : (z : ℤ)
              → let C = Coprime.sym $ Coprime.1-coprimeTo ℤ.∣ z ∣ in
                toℚ (Fromℤ.fromℤ-Rational z) ≡ ℚ.mkℚ z 0 C
    toℚ∘fromℤ z = begin
