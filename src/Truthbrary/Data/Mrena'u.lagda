  ...
  module _*_ where
    ...
    *-ass = {!!}
    ...
    ∃[R[I*I]] = (√2 , _) , ((λ x → x , x) {!!}) , R
      ...
      R[r]∧r≈s⇒R[s] = {!!}
      R = R[r]∧r≈s⇒R[s] (fromℕ 2) (√2 * √2) (Fromℕ.fromℕ-Rational 2) {!!}
