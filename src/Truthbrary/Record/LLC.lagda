...
\section{la'oi .\F{UL}.}
ni'o ga jo la'o zoi.\ \B A \AgdaOperator{\AgdaInductiveConstructor{,}} \B b .zoi.\ ctaipe la'o zoi.\ zoi.\ \F{UL} \B A .zoi.\ gi ro da poi ke'a selvau ko'a goi la'oi .\B A.\ zo'u li pa du lo nilzilcmi be lo'i ro selvau be ko'a be'o poi ke'a du da
